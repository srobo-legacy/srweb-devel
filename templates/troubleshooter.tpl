...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{$root_uri}resources/troubleshooter/style.css" />
...
<div id="pageWrapper">
	...
	<div id="{$page_id}" class="content docs">
        ...
        <script type="application/javascript" src="{$root_uri}resources/troubleshooter/data.json"></script>
        <script type="application/javascript" src="{$root_uri}resources/troubleshooter/troubleshoot.js"></script>
	</div>
